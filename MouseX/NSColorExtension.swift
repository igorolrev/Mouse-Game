...
let colors = [NSColor.turquoiseColor(),
    ...
    NSColor.pomergranateColor(),
    NSColor.asbestosColor(),
    NSColor.pinkColor(),
    NSColor.darkPinkColor(),
    NSColor.BrownColor()
]
...
extension NSColor {
    ...
    class func pinkColor()->NSColor {
        return NSColor(r:237, g:64, b:252)
    }
    class func darkPinkColor()->NSColor {
        return NSColor(r:226, g:41, b:126)
    }
    class func BrownColor()->NSColor {
        return NSColor(r:179, g:110, b:0)
    }
    
    
    class func AlertRedColor()->NSColor {
        return NSColor(r:141, g:16, b:3)
    }
